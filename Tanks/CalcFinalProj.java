...
public class CalcFinalProj extends java.applet.Applet implements ActionListener, MouseListener, MouseMotionListener, KeyListener //use frames to delay the bounce count of the bullets
{
	Timer t;
	Image picture;
